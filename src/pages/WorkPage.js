...
const properties = {
  ...
  prevArrow: (
    <div
      className="arrow-btn"
      style={{ fontSize: '4rem', position: 'absolute', left: '1.5rem' }}
    >
  ...
  nextArrow: (
    <div
      className="arrow-btn"
      style={{ fontSize: '4rem', position: 'absolute', right: '1.5rem' }}
    >
...
const WorkPage = (props) => {
  {
    ...
    useEffect(() => {
      if (window.scrollY > 0)
        gsap.to(window, {
          duration: 2,
          scrollTo: { y: '#workSection', ease: 'power2.inOut', offsetY: 100 },
        })
    ...
    return (
      <>
          ...
          <div className="section__content">
            ...
            <div className="section__content-row work-row">
              <div className="section__content-row-item work-item">
                <span className="section__content-row-item-heading">
                  project name
                </span>
              ...
              <div className="section__content-row-item work-item">
                ...
                {link ? (
                  <a
                    href={link}
                    target="_blank"
                    className="pill-btn margin-top--small"
                  >
                    launch
                  </a>
                ) : null}
            ...
            <div className="row">
              ...
              <div className="row__item">
                <a
                  href="#"
                  onClick={(e) => onPrev(e)}
                  className="pill-btn margin-right--small"
                >
                  prev
                </a>{' '}
                <a href="#" onClick={(e) => onNext(e)} className="pill-btn">
                  next
                </a>
              </div>
            </div>
        ...
        <Footer linkedin="https://www.linkedin.com/in/fgudino/" />
      </>
    )
  }
}
