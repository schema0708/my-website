...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    if (window.scrollY > 0)
      gsap.to(window, {
        duration: 2,
        scrollTo: { y: '#welcome', ease: 'power2.inOut', offsetY: 100 },
      })
  }
  ...
  onScrollToWorks = (e) => {
    ...
    gsap.to(window, {
      duration: 2,
      scrollTo: { y: '#workSection', ease: 'power2.inOut', offsetY: 70 },
    })
  }
  checkImageType = (element) => {
    ...
    if (type === 'ad') {
      return (
        <Link className="work-link">
          <LazyLoadImage
            onClick={(e) => this.props.openBox(e, element)}
            src={src}
            effect="opacity"
            width="100%"
            alt={title}
    ...
    } else if (type === 'games' || type === 'web/3d') {
      return (
      ...
      <>
        <header id="welcome" className="page-1 home">
          <div className="home__welcome">
            <h1 className="heading-1 home__welcome-title heading--large">
              Greetings!
            </h1>
            <div className="divider-1 divider"></div>
            <h1 className="copy-1 heading--large">
              Thank you for visiting my portfolio, where you can view some of my
              works below, enjoy!
            </h1>
            <a
              href="#"
              onClick={(e) => this.onScrollToWorks(e)}
              className="btn-1 page__btn pill-btn margin-top--medium"
            >
              view work
            </a>
          </div>
          <div className="mouse">
            ...
            <img
              className="mouse__icon mouse-icon"
              src={mouseicon}
              alt="mouse-scroll"
            />
          </div>
        ...
        <section id="workSection" className="section margin-top--medium">
          <div className="section__content works">
            ...
            <h1 className="heading--large works__copy margin-top--small">
              Here are some of my{' '}
              <span className="work-title">{this.state.title}</span> works
              below.
            </h1>
            ...
            <div className="works__filters margin-top--medium  margin-bottom--small">
              ...
              <a
                href="#"
                onClick={(e) => this.onFilterWork(e, 'ad', 0)}
                className={`works__filters-btn pill-btn ${
              ...
              <a
                href="#"
                onClick={(e) => this.onFilterWork(e, 'ui/ux', 1)}
                className={`works__filters-btn pill-btn ${
              ...
              <a
                href="#"
                onClick={(e) => this.onFilterWork(e, 'games', 2)}
                className={`works__filters-btn pill-btn ${
              ...
              <a
                href="#"
                onClick={(e) => this.onFilterWork(e, 'web/3d', 3)}
                className={`works__filters-btn pill-btn ${
                  this.state.activeIndex === 3 ? 'active' : ''
                }`}
              >
                web/3d
              </a>
        ...
        <Footer
          linkedin="https://www.linkedin.com/in/fgudino/"
          instagram="https://www.instagram.com/abel121677/"
        />
      </>
    )
  }
